...
`include "alphacore_gen.v" //_\TLV
   ...
   //_|cpu
      ...
      //Fetch
         ...
         assign CPU_imem_rd_addr_a0[31:0] = CPU_pc_a0[5+1:2];
   ...
   //  o CPU visualization
   //_|cpu
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 16   // Instantiated from alphacore.tlv, 256 as: m4+imem(@1)
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 31   // Instantiated from alphacore.tlv, 257 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      //_\source /raw.githubusercontent.com/shivanishah269/riscvcore/master/FPGAImplementation/riscvshelllib.tlv 48   // Instantiated from alphacore.tlv, 258 as: m4+dmem(@4)
         // Data Memory
         //_@4
